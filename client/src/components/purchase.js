  ...
  render() {
    return (
      <div id="product-purchase">
        <div id="product-purchase-price">
            <div className="price-container">
              <div className="price-infobox inline-block">
                <div className="price-name">{this.props.product.name}</div>
                <div className="price-description">{this.props.product.shortName + ((this.props.product.variantProduct) ? ',' : '')}</div>
                <div className="purchase-text">{this.props.product.variantType}</div>
              </div>
              <div>
        ...
        <div className="bottom-space flex">
            <div className="cart-add">Add to cart</div>
            <div className="cart-like">
              <div>♡</div>
            </div>
        </div>
        <div className="product-purchase-availability">
            <div className="availability-delivery">
              <svg className="availability-svg" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="availability-spacer">You can see stock availability and delivery options at checkout.</div>
            </div>
            <div className="availability-stock">
              <svg className="availability-svg" viewBox="0 0 24 24" aria-hidden="true">
