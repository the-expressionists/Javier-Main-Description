...
db.query(
    ...
    '${path.join(__dirname, '../csvData/products.csv')}'DELIMITER ',' CSV;`
)
	.then(() => {
...
db.query(
    ...
    '${path.join(__dirname, '../csvData/images.csv')}'DELIMITER ',' CSV;`
)
	.then(() => {
...
db.query(
    ...
    '${path.join(__dirname, '../csvData/breadcrumbs.csv')}'DELIMITER ',' CSV;`
)
	.then(() => {
...
db.query(
    ...
    '${path.join(__dirname, '../csvData/variants.csv')}'DELIMITER ',' CSV;`
)
	.then(() => {
...
console.log(path.join(__dirname, '../csvData/products.csv'));
