...
const productsStream = fs.createWriteStream(path.join(__dirname, '../csvData/products.csv'));
const imagesCsv = fs.createWriteStream(path.join(__dirname, '../csvData/images.csv'));
const breadcrumbsCsv = fs.createWriteStream(path.join(__dirname, '../csvData/breadcrumbs.csv'));
const variantsCsv = fs.createWriteStream(path.join(__dirname, '../csvData/variants.csv'));
...
productTable(productData, productsStream, 'utf-8', () => {
